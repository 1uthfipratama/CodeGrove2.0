    ...
    <main class="cg-container">
        <section class="cg-hero mb-4">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                <div>
                    <div class="cg-hero-title">Your questions</div>
                    <div class="cg-hero-subtitle">Track your threads, see replies, and keep conversations alive.</div>
                </div>
                <div class="d-flex gap-2 align-items-center">
                    <a href="/add-question" class="cg-btn-primary">Add another</a>
                </div>
            </div>
        </section>

        <div class="cg-card cg-filter-card mb-4">
            <form action="/my-questions" method="get" id="filterForm" class="cg-form">
            ...
            @foreach ($posts as $post)
                ...
                <article class="cg-card cg-post-card position-relative">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                        ...
                        <a href="/post/{{$post->id}}" class="cg-link">View details</a>
                    </div>
                </article>
            @endforeach
        </section>
